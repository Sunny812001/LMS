...
public class ReturnBook extends javax.swing.JFrame {
     ...
     */
    public ReturnBook(DisplayManager Dmgr) {
        this.Dmgr=Dmgr;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Return Book ____ Swetsubhra Sarkar ____ 08");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jRadioButton1.isSelected())
            ...
            Damage="not damaged";
        if(Dmgr.CheckOut(new Book(Integer.parseInt(this.jTextField3.getText()),"",this.jTextField4.getText(),"","","","","",0),new Member(Long.parseLong(this.jTextField1.getText()),this.jTextField2.getText(),0,"","","",""),new Loan(this.jTextField5.getText(),this.jTextField6.getText(),0,Damage))){
            Dmgr.ShowScreen9();
        }
...
//            public void run() {
//                new ReturnBook(new LoanManager()).setVisible(true);
//            }
//        });
//    }
