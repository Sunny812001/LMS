...
public class CheckAvailability extends javax.swing.JFrame {
   ...
   private DisplayManager Dmgr;
     ...
     */
    public CheckAvailability(DisplayManager Dmgr){
        this.Dmgr=Dmgr;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Check Availabilty____Vishal Kumar Sinha ____ 03");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       if(Dmgr.search(new Book(0,"",this.jTextField1.getText(),this.jTextField2.getText(),"","","","",0)))
            JOptionPane.showMessageDialog(this,"BookFound");
        else
            JOptionPane.showMessageDialog(this,"BookNotFound");       
...
//            public void run() {
//                new CheckAvailability(new BookManager()).setVisible(true);
//            }
//        });
//    }
