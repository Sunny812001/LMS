...
public class Fine extends javax.swing.JFrame {
     ...
     */
    public Fine(DisplayManager Dmgr) {
        this.Dmgr=Dmgr;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "FINE", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("sansserif", 1, 14))); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("F:\\B.TECH CLASS\\software engineering lab\\Code\\LMS\\LMS\\src\\profile.png")); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String  Damage="not damaged";
        if(jRadioButton1.isSelected())
            Damage="damaged";
        else if(jRadioButton2.isSelected())
            Damage="not damaged";
        JOptionPane.showMessageDialog(this,"Fine to be paid :"+Dmgr.CheckFine(new Loan(this.jTextField1.getText(),this.jTextField2.getText(),0,Damage)));
